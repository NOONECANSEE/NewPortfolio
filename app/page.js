...
//         className="flex justify-between items-center px-6 md:px-12 py-5 border-b border-gray-800 sticky top-0 bg-black/70 backdrop-blur-xl z-50"
//       >
//         <h1 className="text-xl md:text-2xl font-bold tracking-wide bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">
//           Anshu Singla
//         </h1>
...
//           <a
//             href="#contact"
//             className="bg-gradient-to-r from-purple-500 to-blue-500 px-5 py-2 rounded-xl text-sm hover:scale-105 transition"
//           >
//             Hire Me
//           </a>
//         </div>
...
//           initial={{ opacity: 0 }}
//           animate={{ opacity: 1 }}
//           className="md:hidden flex flex-col items-center gap-6 py-6 border-b border-gray-800 bg-black"
//         >
//           {["about", "projects", "tech", "contact"].map((item) => (
...
//       {/* TECH STACK */}
//       <section id="tech" className="py-28 px-6 bg-gray-950">
//         <div className="max-w-6xl mx-auto">
//           <h2 className="text-3xl font-bold mb-16 text-center">Tech Stack</h2>
...
//               {
//                 title: "Cloud",
//                 items: ["AWS Lambda", "API Gateway", "S3"],
//               },
//             ].map((stack, i) => (
//               <motion.div
//                 key={i}
//                 whileHover={{ y: -8, scale: 1.03 }}
//                 className="border border-gray-800 rounded-2xl p-6 bg-black/40 backdrop-blur hover:border-purple-500/40 transition"
//               >
//                 <h3 className="font-semibold mb-4 text-lg">{stack.title}</h3>
...
//             ["99.9%", "API Uptime"],
//           ].map((stat, i) => (
//             <div key={i} className="border border-gray-800 rounded-2xl p-6">
//               <h3 className="text-3xl font-bold text-purple-400">{stat[0]}</h3>
//               <p className="text-gray-400 text-sm">{stat[1]}</p>
//             </div>
//           ))}
//         </div>
//       </section>
